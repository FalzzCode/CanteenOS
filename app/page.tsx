...
function PlaceholderPage({ activeNav, onNavigate, outletId = "demo", showModule = true }: { activeNav: NavKey; onNavigate: (key: NavKey) => void; outletId?: string; showModule?: boolean }) {
  if (showModule) return <OperationsModule activeNav={activeNav as ModuleKey} outletId={outletId} />;
